...
\begin{itemize}
    ...
    \begin{figure}[h!]
        ...
        \begin{tikzpicture}[
            ...
            \draw [gray,thick,yshift=-0.4cm,xscale=1.25] plot [domain=-0.7:1.4,smooth] (\x,{0.5*(e^\x+e^(-\x))});

            \draw (1.3,0.94) arc[start angle=0,end angle=27,radius=0.4cm] node[right,yshift=-1.3mm]{$\phi$};

            \draw [ylx,very thick,-latex] (1,0.94) -- (1.7,1.44) node[fill=white,inner sep=2pt,above left]{$T$};
            \draw [ylx,thick,-latex] (1,0.94) -- node[below]{$T\cos\phi$} ++(0.7,0);
            \draw [ylx,thick,-latex] (1.7,0.94) -- (1.7,1.44) node[below right]{$T\sin\phi$};
            ...
            \node [circle,fill,inner sep=1.5pt,label={above left:$P(x,y)$}] at (1,0.94) {};
            ...
            \begin{scope}[xshift=3cm]
                ...
                \draw [gray,ultra thick] (0,0) -- (2,1.5);

                \draw [ylx,line width=2pt] (1,0.75) -- node[below]{$\dd x$} (1.6,0.75) -- node[right]{$\dd y$} (1.6,1.2) -- node[above,xshift=-1mm]{$\dd s$} (1,0.75);
